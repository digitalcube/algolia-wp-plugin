 ...
 * @since 0.0.0
 */
class AlgoliaPostTypes extends Widget_Base
{
	/**
	 * Class constructor.
	 *
	...
	{
		return __('Algolia Post Types', 'algolia-post-types');
	}
	...
	protected function _register_controls()
	{
		$this->start_controls_section(
			'section_title',
			[
				'label' => __('Algolia Post Types', 'algolia-wp-plugin'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '<div id="facet-post-types"></div>',

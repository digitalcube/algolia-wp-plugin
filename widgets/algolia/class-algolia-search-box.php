 ...
 * @since 0.0.0
 */
class AlgoliaSearchBox extends Widget_Base
{
	/**
	 * Class constructor.
	 *
	...
	{
		return __('Algolia Search Box', 'algolia-search-box');
	}
	...
	protected function _register_controls()
	{
		$this->start_controls_section(
			'section_title',
			[
				'label' => __('Algolia Search Box', 'algolia-wp-plugin'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '<div id="algolia-search-box"></div>',
